...
#Ref: https://www.kaggle.com/gargmanish/how-to-handle-imbalance-data-study-in-detail
import pandas as pd # to import csv and for data manipulation
import matplotlib.pyplot as plot # to plot graph
...
from sklearn.model_selection import KFold, GridSearchCV as gSearch, train_test_split as tts, RandomizedSearchCV as rSearch #for tunning hyper parameter but uses random combinations of parameters
from sklearn.metrics import confusion_matrix,recall_score,precision_recall_curve,auc,roc_curve,roc_auc_score,classification_report
from imblearn.over_sampling import SMOTE
#Import dataset and pre-processing
data=pd.read_csv('creditcard fraud detect.csv')
data.info()
...
#Amount related to normal and fraud transcation
...
#Plot the distribution for Normal transction
Fraud_transacation = data[data["Class"]==1]
Normal_transacation= data[data["Class"]==0]
plot.figure(figsize=(10,6))
plot.subplot(121)
...
#Undersampling by a portion of majority class and will take whole data of minority class
...
def model(model,features_train,features_test,labels_train,labels_test):
    ...
    plot.title("Confusion_matrix")
    plot.xlabel("Predicted_class")
    plot.ylabel("Real class")
    plot.show()
...
data.head()
#SMOTE as the function for oversampling
